...
export default function Intro() {
  ...
  const downloadAvatar = () => {
    ...
    a.href = composedUrl;
    a.download = "billions-avatar.png";
          ...
          <div className="grid lg:grid-cols-2 gap-4">
            ...
            <div className="flex flex-col items-center gap-3">
              <div
                ...
                style={{
                  backgroundImage: `url(${
                    composedUrl || avatarUrl || "/default-avatar.png"
                  })`,
            ...
            <div className="grid gap-3">
              <div className="grid md:grid-cols-3 gap-2 items-end">
                ...
                <div className="flex">
                  <button
                    onClick={fetchAvatar}
                    className="px-3 py-2 rounded-2xl bg-white text-black font-semibold w-full"
                  >
                    Load Avatar
                  </button>
                </div>
              ...
              <div className="mt-4 flex items-center justify-center">
                <button
                  onClick={startGame}
                  className="px-6 py-3 rounded-2xl bg-white text-black font-bold shadow hover:scale-[1.02] transition"
                >
                  Start
                </button>
              </div>
...
function Range({
  ...
  return (
    <label className="grid gap-1 text-xs text-white/70">
      <span>
        {label}: <b className="text-white">{value.toFixed(2)}</b>
      </span>
      <input
        type="range"
        min={min}

...
const share = () => {
    const text = encodeURIComponent(`I scored ${power} POWER in Billions Neon! @billions_ntwk @traderibo123`);
  ...
  return (
    <div className="min-h-screen w-full bg-black text-white flex items-center justify-center p-4 select-none">
      <div className="w-full max-w-5xl relative">
        ...
        {uiOpen && (
          <div className="mb-3 rounded-2xl border border-white/20 bg-white/5 p-3 grid gap-3">
            <div className="grid md:grid-cols-5 gap-2 items-end">
              ...
              <div className="md:col-span-2">
                <!-- removed glasses path field -->
                <!-- glasses path input removed -->setGlassesUrl(e.target.value)} className="w-full mt-1 px-3 py-2 rounded-xl bg-white/10 border border-white/20" />
              </div>
        ...
        <footer className="mt-4 text-xs text-white/60">Fan-made visual demo • Tag <span className="font-semibold text-white">@billions_ntwk @traderibo123</span>.</footer>
      </div>
    </div>
  );
}
